 ...
 */
@Component(value = "ETOMINIAPP")
@Slf4j
public class MiniAppServiceImpl implements SystemTypeService {
    @Autowired
    ...
    public void getResultBySystem(AccountIdentityVo result, List<UserRole> userRoleList, Map<Long, String> roleNameMap) {
        ...
        for (UserRole userRole : userRoleList) {
            ...
            if (StrUtil.isNotEmpty(weChatInfoIdStr)) {
                ...
                List<BrandsWechatInfo> weChatInfos = repository.findByTypeAndIdIn(WeChatAppTypeEnum.MINI_APP.getCode(), weChatInfoIds);
            ...
            identityDetail.setMiniAppList(miniAppList);
